...
class IsOnShoreInternationalStudent() : Rule<Identity, Calculated>() {
    ...
    override fun execute(source: Identity, calculations: Calculated): Boolean? {
        ...
        returns(calculations::onshoreInternationalStudent)

        return if (citizenshipCode == null) {
            false
        } else {
            (currentStudent || intermitStudent || currentApplicant || graduandStudent) && citizenshipCode == "4"
        }
    }
