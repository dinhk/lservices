...
//Implements SVC_FINANCE_UTIL.GENERATE_EMPLOYMENT_STATUS
class BestOccupancyEmploymentStatus : Rule<Identity, Calculated>() {
    override fun execute(source: Identity, calculations: Calculated): String? {
        ...
        returns(calculations::bestOccupancyEmploymentStatus)

        return bestCurrentOccupancy?.employmentStatus
    }
}