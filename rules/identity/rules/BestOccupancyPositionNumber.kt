...
//Implements SVC_FINANCE_UTIL.GENERATE_POSITION_NUMBER
class BestOccupancyPositionNumber : Rule<Identity, Calculated>() {
    override fun execute(source: Identity, calculations: Calculated): String? {
        ...
        returns(calculations::bestOccupancyPositionNumber)

        return bestCurrentOccupancy?.positionId
    }
}