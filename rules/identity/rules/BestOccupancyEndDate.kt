...
//Implements SVC_FINANCE_UTIL.GENERATE_OCCUPANCY_END_DATE
class BestOccupancyEndDate : Rule<Identity, Calculated>() {
    override fun execute(source: Identity, calculations: Calculated): Any? {
        ...
        returns(calculations::bestOccupancyEndDate)

        return bestOccupancy?.endDate
    }
}