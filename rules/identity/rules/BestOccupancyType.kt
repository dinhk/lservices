...
//Implements SVC_FINANCE_UTIL.GENERATE_OCCUPANCY_TYPE
class BestOccupancyType : Rule<Identity, Calculated>() {
    override fun execute(source: Identity, calculations: Calculated): String? {
        ...
        returns(calculations::bestOccupancyType)

        return bestCurrentOccupancy?.occupancyTypeCode
    }
}