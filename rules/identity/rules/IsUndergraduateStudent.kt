...
class IsUndergraduateStudent() : Rule<Identity, Calculated>() {
    ...
    override fun execute(source: Identity, calculations: Calculated): Boolean? {
        ...
        returns(calculations::undergraduateStudent)
        ...
        return currentCourseAttempts.any {
                it.spkCategoryTypeCode in listOf("108","109","110","111","116","130","131")
        }
    }
