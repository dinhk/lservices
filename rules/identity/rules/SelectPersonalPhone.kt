...
class SelectPersonalPhone : Rule<Identity, Calculated>() {
    override fun execute(source: Identity, calculations: Calculated): String? {
        ...
        val landlines = changedNullableAttribute(person.landlines, person::landlines)

        returns(calculations::personalPhone)
        ...
        val entry = landlines.firstOrNull { it.contactType == "Personal" && it.contactPreference == "Transactional" }
                ?: return null
