...
//Implements SVC_FINANCE_UTIL.GENERATE_POSITION_CATEGORY
class BestOccupancyPositionCategory : Rule<Identity, Calculated>() {
    override fun execute(source: Identity, calculations: Calculated): String? {
        ...
        returns(calculations::bestOccupancyPositionCategory)

        return bestCurrentOccupancy?.occupancyPositionCategoryCode
    }
}